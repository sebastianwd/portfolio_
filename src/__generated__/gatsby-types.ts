...
export type PrismicProjectsAndCategoriesQuery = { readonly allPrismicCategory: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<PrismicCategory, 'prismicId'>
        & { readonly data: Maybe<Pick<PrismicCategoryData, 'name'>> }
      ) }> }, readonly allPrismicProject: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<PrismicProject, 'uid'>
        & { readonly data: Maybe<(
          Pick<PrismicProjectData, 'title' | 'overview' | 'repository'>
